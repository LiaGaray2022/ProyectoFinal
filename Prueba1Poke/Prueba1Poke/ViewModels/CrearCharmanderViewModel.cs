...
{
    public class CrearCharmanderViewModel : INotifyPropertyChanged
    {
        ...
        public static CrearCharmanderViewModel Instance { get; } = new CrearCharmanderViewModel();

        public CrearCharmanderViewModel()
        {
        ...
        private void GuardarPokemon()
        {
            ...
            Pokemon nuevoPokemon = new Charmander(Nombre, FechaNacimiento);
        ...
        {
            if (pokemon is Charmander)
            {
                return "Cambio de poder: Calor -> Fuego";
            }
            else if (pokemon is Charmeleon)
            {
                return "Cambio de poder: Fuego -> Lanza Llamas";
            }
            else
            {
